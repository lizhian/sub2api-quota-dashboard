...
test('leaves per-million token spending empty without tokens', () => {
  const metrics = metricsFromUsageStats({ total_cost: 2.5 })
  assert.equal(metrics.spendPerMillionTokens, null)
})
